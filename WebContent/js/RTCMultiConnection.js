(function() {
    ...
    function setDefaults(connection) {
        ...
        var socket = io.connect('node.codetantra.com/');
        var SIGNALING_SERVER = 'node.codetantra.com/';
        /*var socket = io.connect('https://www.codetantra.com/node');
        var SIGNALING_SERVER = 'https://www.codetantra.com/node';*/
