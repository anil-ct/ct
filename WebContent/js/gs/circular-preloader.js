...
function GSPreloader(options) {
  ...
  var parent = options.parent || document.body,
      element = this.element = options.element || document.createElement("div"),
  ...
  TweenLite.set(box, {width: radius * 2 + 70, height: radius * 2 + 70, borderRadius:"14px", position:"absolute", xPercent:-50, yPercent:-50, opacity:((options.boxOpacity != null) ? options.boxOpacity : 0.3)});
