...
var WikEdDiff = function () {
	...
	this.config = {
		...
		'stylesheet':
			...
			// Delete
			'.wikEdDiffDelete {' +
			'font-weight: bold; background-color: #FF5E2F /*#ffe49c*/; ' +
			'color: #222; border-radius: 0.25em; padding: 0.2em 1px; ' +
			'} ' +
			'.wikEdDiffDeleteBlank { background-color: #ffd064; } ' +
			'.wikEdDiffFragment:hover .wikEdDiffDeleteBlank { background-color: #FF5E2F /*#ffe49c*/; } ' +
			...
			'.wikEdDiffContainer { } ' +
			'.wikEdDiffFragment {' +
			'white-space: pre-wrap; background: black; border: red/*#bbb*/ solid; ' +
			'border-width: 1px 1px 1px 0.5em; border-radius: 0.5em; font-family: monospace; color: #fff; ' +
			...
			'.wikEdDiffTabSymbol:before { content: "→"; font-weight: bold; color: #ccc;/*font-size: smaller; color: #ccc;*/ } ' +
			'.wikEdDiffBlock .wikEdDiffTabSymbol:before { color: #aaa; } ' +
			'.wikEdDiffBlockHighlight .wikEdDiffTabSymbol:before { color: #aaa; } ' +
			'.wikEdDiffInsert .wikEdDiffTabSymbol:before { color: black/*#aaa*/; } ' +
			'.wikEdDiffDelete .wikEdDiffTabSymbol:before { color: black/*#bbb*/; } ' +
    ...
    'wiked-diff-same':  '=',
    'wiked-diff-ins':   'Inserted',
    'wiked-diff-del':   'Removed',
	...
	this.config.htmlCode = {
		...
		'fragmentStart': '<pre class="wikEdDiffFragment" style="white-space: pre-wrap; color:white; font-size: 16px;">',
		'fragmentEnd': '</pre>',
