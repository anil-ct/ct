...
function introGuide() {
	...
	introjs.onafterchange(function(targetElement) {
		...
		break;
		case "defaultConst":
			$("#defaultConst").removeClass("opacity00");
			introjs.refresh();
			$('.introjs-nextbutton').hide();
			$('.introjs-prevbutton').hide();
			$(".introjs-helperLayer").one("transitionend", function() {
		...
		case "addFiveFun":
			if (introjs._currentStep == 6) {
				$("#addFiveFun").removeClass("opacity00");
				introjs.refresh();
				$('.introjs-nextbutton').hide();
				$('.introjs-prevbutton').hide();
				$(".introjs-helperLayer").one("transitionend", function() {
				...
				$("#totalAddFiveFun").removeClass("opacity00");
				introjs.refresh();
				$('.introjs-nextbutton').hide();
				$('.introjs-prevbutton').hide();
				$(".introjs-helperLayer").one("transitionend", function() {
		...
		break;
		case "friendFun":
			$("#friendFun").removeClass("opacity00");
			introjs.refresh();
			$('.introjs-nextbutton').hide();
			$('.introjs-prevbutton').hide();
			$(".introjs-helperLayer").one("transitionend", function() {
...
<div class='text-center margin-top-20'>
	<h4 class='label ct-demo-heading' id='demoTitle'>Friend Class</h4>
</div>
...
<g>class</g> <blue>Distance</blue> {
	...
	<span id="defaultConst" class="opacity00"><g>public</g>:
		Distance() {
			meter = 0;
		}</span>
		<span id="friendFun" class="opacity00"><b>//friend function</b>
		<span id="friend" class=""><g>friend</g></span> <red>int</red> addFive(Distance);</span>
};

<span id="totalAddFiveFun" class="opacity00"><b>//friend function definition</b></span>
<span id="addFiveFun" class="opacity00"><red>int</red> addFive(Distance d) {
	<b>//accessing private data from non-member function</b>
	<span id="meterInit">d.meter = meter + 5;</span>
	return d.meter;
}</span>
<red>void</red> main() {
	<span id="constD" class="opacity00">Distance D;</span>
	<span id="cout" class="opacity00">cout << <red>"Distance: "</red> << <span id="callMethod">addFive(D);</span></span>
}
</pre>
		</div>
	</div>
